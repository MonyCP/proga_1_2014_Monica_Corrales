...
public class Atributes {
    ...
    while(validar)
    {
        System.out.println("Digite 1 si quiere realizar un despósito y 2 si quiere realizar un retiro");
        ...
        if(opcion==2)
        {
            ...
            if(oAccount.isHayErrror())
            {
              System.out.println("el monto que usted desea retirar no puede ser retirado");
            }
        } 
         ...
         {
             validar=false;
             System.out.println("Que tengo un buen día");
         }
